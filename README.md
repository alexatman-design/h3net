...
El proyecto está diseñado para utilizar los datos oficiales del INPC publicados por el INEGI (www.inegi.org.mx). Para comenzar rápidamente, el repositorio incluye un archivo de ejemplo con datos desde enero 2023 hasta el mes actual (agosto 2026), cambiando con el paso de los meses de manera automatica segun el parrafo anterior. Para usar datos oficiales, reemplace este archivo con los datos del INPC obtenidos directamente del INEGI.
